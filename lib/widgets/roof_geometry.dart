...
const Map<String, ShapeTemplate> kShapeTemplates = {
  ...
  'L-Shape': ShapeTemplate(
    turns: [1, 1, 1, -1, 1],   // 5 turns for 6 edges; R after E4 (inside notch corner)
    edgeLabels: [
      'E1 – Bottom edge, full width (ft)',
      'E2 – First vertical side (ft)',
      'E3 – Top partial edge (ft)',
      'E4 – Step / notch depth (ft)',
      'E5 – Inner horizontal edge (ft)',
      'E6 – Second vertical side (ft)',
    ],
    diagram:
        '┌──E5──┬──E3──┐\n'
        'E6     E4      E2\n'
